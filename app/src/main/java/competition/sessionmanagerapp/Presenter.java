...
public class Presenter extends Fragment implements OnFragmentInteractionListener, ViewPager.OnPageChangeListener, TabHost.OnTabChangeListener{
    ...
    public void setContactDetails (String n, String e, String l){
        ((Session)tabs[0]).setContactDetails(n, e, l);
    }
    ...
    public Presenter() {
        tabs = new Fragment[]{new Session(), new Contacts(this)};
    }
     ...
     * @return A new instance of fragment Presenter.
     */
    // TODO: Rename and change types and number of parameters
    public static Presenter newInstance(String param1, String param2) {
        Presenter fragment = new Presenter();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.presenter, container, false);
        initViewPager();
        initTabHost();
        return view;
    }
    ...
    private void initTabHost (){
        ...
        tabHost.setup();
        String[] tabNames = {"Session", "Contact"};
    ...
    public void onTabChanged(String s) {
        ...
        HorizontalScrollView horizontalScrollView = (HorizontalScrollView) view.findViewById(R.id.horizontalScroller);
